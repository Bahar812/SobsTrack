...
use App\Models\FollowUpProspect;
use Illuminate\Http\Request;

class FollowUpProspectController extends Controller
{
    public function index(Request $request)
    {
        $query = FollowUpProspect::with('user:id,name,branch_id', 'user.branch:id,name');
    ...
    public function store(Request $request)
    {
        ...
        $record = FollowUpProspect::create([
